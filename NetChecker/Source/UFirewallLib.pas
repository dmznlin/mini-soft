...
// PASTLWTR : 1.2
// File generated on 01/09/2015 19:51:29 from Type Library described below.
...
const
  ...
  IID_INetFwRule3: TGUID = '{B21563FF-D696-4222-AB46-4E89B73AB34A}';
...
// *********************************************************************//
  INetFwRule3 = interface(INetFwRule2)
    ['{B21563FF-D696-4222-AB46-4E89B73AB34A}']
    function Get_LocalAppPackageId: WideString; safecall;
    procedure Set_LocalAppPackageId(const wszPackageId: WideString); safecall;
    function Get_LocalUserOwner: WideString; safecall;
    procedure Set_LocalUserOwner(const wszUserOwner: WideString); safecall;
    function Get_LocalUserAuthorizedList: WideString; safecall;
    procedure Set_LocalUserAuthorizedList(const wszUserAuthList: WideString); safecall;
    function Get_RemoteUserAuthorizedList: WideString; safecall;
    procedure Set_RemoteUserAuthorizedList(const wszUserAuthList: WideString); safecall;
    function Get_RemoteMachineAuthorizedList: WideString; safecall;
    procedure Set_RemoteMachineAuthorizedList(const wszUserAuthList: WideString); safecall;
    function Get_SecureFlags: Integer; safecall;
    procedure Set_SecureFlags(lOptions: Integer); safecall;
    property LocalAppPackageId: WideString read Get_LocalAppPackageId write Set_LocalAppPackageId;
    property LocalUserOwner: WideString read Get_LocalUserOwner write Set_LocalUserOwner;
    property LocalUserAuthorizedList: WideString read Get_LocalUserAuthorizedList write Set_LocalUserAuthorizedList;
    property RemoteUserAuthorizedList: WideString read Get_RemoteUserAuthorizedList write Set_RemoteUserAuthorizedList;
    property RemoteMachineAuthorizedList: WideString read Get_RemoteMachineAuthorizedList write Set_RemoteMachineAuthorizedList;
    property SecureFlags: Integer read Get_SecureFlags write Set_SecureFlags;
  end;

// *********************************************************************//
// DispIntf:  INetFwRule3Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {B21563FF-D696-4222-AB46-4E89B73AB34A}
// *********************************************************************//
  INetFwRule3Disp = dispinterface
    ['{B21563FF-D696-4222-AB46-4E89B73AB34A}']
    property LocalAppPackageId: WideString dispid 20;
    property LocalUserOwner: WideString dispid 21;
    property LocalUserAuthorizedList: WideString dispid 22;
    property RemoteUserAuthorizedList: WideString dispid 23;
    property RemoteMachineAuthorizedList: WideString dispid 24;
    property SecureFlags: Integer dispid 25;
    property EdgeTraversalOptions: Integer dispid 19;
    property Name: WideString dispid 1;
    property Description: WideString dispid 2;
    property ApplicationName: WideString dispid 3;
