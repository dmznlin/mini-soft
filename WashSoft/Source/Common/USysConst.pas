...
const
  ...
  cFI_FrameMember       = $0010;                     //会员管理
  cFI_FrameChongZhi     = $0011;                     //会员充值
  cFI_FrameWashType     = $0012;                     //衣物类型
  ...
  cFI_FormMember        = $1010;                     //会员档案
  cFI_FormGetMember     = $1011;                     //选择会员
  cFI_FormChongZhi      = $1012;                     //会员充值
...
begin
  ...
  AddMenuModuleItem('MAIN_B01', cFI_FrameWashType);
  AddMenuModuleItem('MAIN_C01', cFI_FrameMember);
  AddMenuModuleItem('MAIN_C02', cFI_FrameChongZhi);
  AddMenuModuleItem('MAIN_C03', cFI_FrameSysLog);
