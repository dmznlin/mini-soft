...
uses
  Windows, Classes, DB, SysUtils, ULibFun, cxGridTableView, cxGridDBTableView,
  cxCustomData, cxImageComboBox, UMgrDataDict, UDataModule, USysConst;
...
begin
  ...
  try
    nView.ClearItems;
    if not LoadEntity(nEntity, True) then Exit;
